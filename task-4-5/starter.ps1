...
New-AzureRmResourceGroupDeployment -ResourceGroupName $resourceGroupName -sastokenurl $sastokenurl -TemplateUri $templateURI -TemplateParameterFile $ParametersFilePath
