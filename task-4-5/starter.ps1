...
New-AzureRmResourceGroupDeployment -ResourceGroupName $resourceGroupName -TemplateUri $templateURI -sastokenurl $sastokenurl -TemplateParameterFile $ParametersFilePath
